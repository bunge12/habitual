              ...
              <div class="input-group pending-buttons">
                ...
                <div class="input-group-append">
                  <form action="/orders/${data.orderid}" method="POST" class="accept">
                    ...
                    <button id="a${data.orderid}" class="btn btn-sm btn-outline-success" type="button"
                      data-toggle="collapse" data-target="#collapseExample${data.orderid}" aria-expanded="false"
          ...
          <div class="collapse" id="collapseExample${data.orderid}">
            <div class="card card-body">
              <div class="form-row">
                ...
                <div class="col-4">
                  <button class="btn btn-sm btn-success" type="submit" name="accept">Accept
                    Order</button>
                </div>
              </div>
            </div>
